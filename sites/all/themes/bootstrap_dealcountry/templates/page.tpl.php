...
<header id="navbar" role="banner" class="<?php print $navbar_classes; ?>">
  <div class="container">
    <div class="navbar-header">
      <?php if ($logo): ?>
      <a class="logo navbar-btn pull-left" href="/deals/local" title="<?php print t('Home'); ?>">
...
<div class="main-container container">
  ...
  <div class="row">
  <?php if (!empty($page['main_content'])): ?>
      <div class="col-sm-4" role="complementary">
        <?php print render($page['main_content']); ?>
      </div>
    <?php endif; ?>
	<?php if (!empty($page['menu_content'])): ?>
      <div class="col-sm-8" role="complementary">
        <?php print render($page['menu_content']); ?>
      </div>
    <?php endif; ?>
  </div>
...
<footer class="footer"><div class="container">
	...
	<?php if (!empty($page['footer_2'])): ?>
      <aside class="col-sm-4 col-sm-offset-1" role="complementary">
